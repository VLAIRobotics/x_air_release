...
def interpolate(xarm, comp, joint_id: JointID, delta_rad,
...
def bump_to_limit(xarm, comp, joint_id,
...
def move_to_precise_home(xarm, arm_goal_abs):
...
def _run_right_sequence(xarm, arm, grip):
    d_grip = bump_to_limit(xarm, grip, JointID.GRIPPER)
    time.sleep(0.5)
    d_j4 = bump_to_limit(xarm, arm,  JointID.J4, step_deg=-0.2)
    time.sleep(0.5)

    interpolate(xarm, arm, JointID.J2, np.deg2rad(5),  interp_time=0.4)
    time.sleep(0.5)
    d_j3 = bump_to_limit(xarm, arm,  JointID.J3)
    time.sleep(0.5)

    interpolate(xarm, arm, JointID.J3, -
                mech_lim[JointID.J3][1], interp_time=1.0)
    time.sleep(0.5)
    interpolate(xarm, arm, JointID.J2, -np.deg2rad(5), interp_time=0.4)
    time.sleep(0.5)
    interpolate(xarm, arm, JointID.J4,  np.pi/2.0)
    time.sleep(0.5)

    d_j5 = bump_to_limit(xarm, arm,  JointID.J5)
    time.sleep(0.5)
    interpolate(xarm, arm, JointID.J5, -mech_lim[JointID.J5][1])
    time.sleep(0.5)

    d_j6 = bump_to_limit(xarm, arm,  JointID.J6)
    time.sleep(0.5)
    interpolate(xarm, arm, JointID.J6, -mech_lim[JointID.J6][1])
    time.sleep(0.5)

    d_j7 = bump_to_limit(xarm, arm,  JointID.J7)
    time.sleep(0.5)
    interpolate(xarm, arm, JointID.J7, -mech_lim[JointID.J7][1])
    time.sleep(0.5)

    d_j2 = bump_to_limit(xarm, arm,  JointID.J2, step_deg=-0.2)
    time.sleep(0.5)
    interpolate(xarm, arm, JointID.J2, np.deg2rad(
        10), interp_time=0.9, kp=180, kd=2.0)
    time.sleep(0.5)

    d_j1 = bump_to_limit(xarm, arm,  JointID.J1,
                         step_deg=-0.2, kp=180, kd=2.1)
    time.sleep(0.5)
    interpolate(xarm, arm, JointID.J1, np.deg2rad(80))
    time.sleep(0.5)
...
def _run_left_sequence(xarm, arm, grip):
    d_grip = bump_to_limit(xarm, grip, JointID.GRIPPER)
    time.sleep(0.5)
    d_j4 = bump_to_limit(xarm, arm,  JointID.J4, step_deg=-0.2)
    time.sleep(0.5)
    ...
    d_j2 = bump_to_limit(xarm, arm,  JointID.J2)
    time.sleep(0.5)
    interpolate(xarm, arm, JointID.J2, -np.deg2rad(10),
                interp_time=0.9, kp=180, kd=2.0)
    time.sleep(0.5)

    d_j1 = bump_to_limit(xarm, arm,  JointID.J1, kp=180, kd=2.1)
    time.sleep(0.5)
    interpolate(xarm, arm, JointID.J1, -np.deg2rad(80))
    time.sleep(0.5)
...
def main():
    ...
    # Init
    xarm = oa.XArm(args.canport, True)
    xarm.init_arm_motors(
    ...
    xarm.init_gripper_motor(oa.MotorType.DM4310, 0x08, 0x18)
    xarm.set_callback_mode_all(oa.CallbackMode.STATE)
    ...
    try:
        ...
        ideal, deltas = (_run_right_sequence if args.arm_side == 'right_arm'
                         else _run_left_sequence)(xarm, arm, grip)
        ...
        # TODO: move_to_precise_home(xarm, arm_goal_abs)
