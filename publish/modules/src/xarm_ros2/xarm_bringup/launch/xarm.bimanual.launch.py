...
def robot_nodes_spawner(context: LaunchContext, description_package, description_file,
    ...
    if namespace:
        controllers_file_str = controllers_file_str.replace(
            "xarm_v10_bimanual_controllers.yaml", "xarm_v10_bimanual_controllers_namespaced.yaml"
        )
...
def generate_launch_description():
    """Generate launch description for XArm bimanual configuration."""
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            "controllers_file",
            default_value="xarm_v10_bimanual_controllers.yaml",
